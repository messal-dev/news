...
<body <?php body_class(); ?>>
	...
	<div id="page" class="site">
		<a class="skip-link screen-reader-text" href="#primary-content"><?php esc_html_e( 'Skip to content', 'public-news' ); ?></a>
						...
						<div class="adore-adver">
							...
							<div class="adore-adver-outer">
								<a href="<?php echo esc_url( $advertisement_url ); ?>">
									<img src="<?php echo esc_url( $advertisement_image ); ?>" alt="<?php esc_attr_e( 'Advertisment Image', 'public-news' ); ?>">
								</a>
							</div>
						</div>
					<?php } ?>
