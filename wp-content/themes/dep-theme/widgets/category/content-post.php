<article class="mb-6 w-full lg:basis-[49%]">
    <a href="<?php the_permalink();?>">
        <?php the_post_thumbnail('medium', array('class' => 'w-full h-40 md:h-60 lg:h-60 rounded-sm object-cover'));?>
    </a>
    <div class="my-2">
        <a href="<?php the_permalink();?>">
        ...
        <div class="flex mb-2 lg:mb-4">
            <span class="text-xs lg:mr-4 flex justify-center items-center text-gray-400">
