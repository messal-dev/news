...
if ( $query->have_posts() ) {
	...
	$section_title    = get_theme_mod( 'collective_news_recent_posts_title', __( 'Recent Articles', 'public-news' ) );
	$view_all_btn     = get_theme_mod( 'collective_news_recent_posts_view_all_button_label', __( 'View All', 'public-news' ) );
