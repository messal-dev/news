...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class Collective_News_Toggle_Checkbox_Custom_control extends WP_Customize_Control {
	...
	class Collective_News_Customize_Horizontal_Line extends WP_Customize_Control {
		/**
		 * Control Type
		 */
		public $type = 'hr';
